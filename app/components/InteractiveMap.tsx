...
const SEDES_DATA: SedeHub[] = [
  ...
  {
    id: "florianopolis-sc",
    name: "Sede Regional Santa Catarina",
    badge: "Divisão Litoral Sul",
    coords: [-48.548, -27.5954],
    country: "Brasil",
    state: "SC",
    address: "Av. Beira-Mar Norte, 2100 — Florianópolis/SC",
    meetingDay: "Terças-feiras às 19h30",
    faccoesNum: "32",
    faccoesLabel: "Facções em SC",
    membersNum: "620+",
    membersLabel: "Integrantes",
  ...
  {
    id: "recife-pe",
    name: "Sede Regional Pernambuco",
    badge: "Divisão Costa dos Arrecifes",
    coords: [-34.877, -8.0476],
    country: "Brasil",
    state: "PE",
    address: "Av. Boa Viagem, 3200 — Recife/PE",
